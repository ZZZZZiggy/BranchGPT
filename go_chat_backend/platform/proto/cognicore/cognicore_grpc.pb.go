...
const (
	APIKeyService_ProvideAPIKey_FullMethodName = "/cognicore.APIKeyService/ProvideAPIKey"
)
...
type APIKeyServiceClient interface {
	...
	ProvideAPIKey(ctx context.Context, in *APIKeyRequest, opts ...grpc.CallOption) (*APIKeyResponse, error)
}
...
func (c *aPIKeyServiceClient) ProvideAPIKey(ctx context.Context, in *APIKeyRequest, opts ...grpc.CallOption) (*APIKeyResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(APIKeyResponse)
	err := c.cc.Invoke(ctx, APIKeyService_ProvideAPIKey_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type APIKeyServiceServer interface {
	// Go 调用 Python：传递 API Key
	ProvideAPIKey(context.Context, *APIKeyRequest) (*APIKeyResponse, error)
...
func (UnimplementedAPIKeyServiceServer) ProvideAPIKey(context.Context, *APIKeyRequest) (*APIKeyResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method ProvideAPIKey not implemented")
}
...
func _APIKeyService_ProvideAPIKey_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(APIKeyRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(APIKeyServiceServer).ProvideAPIKey(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: APIKeyService_ProvideAPIKey_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(APIKeyServiceServer).ProvideAPIKey(ctx, req.(*APIKeyRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var APIKeyService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "cognicore.APIKeyService",
	HandlerType: (*APIKeyServiceServer)(nil),
	Methods: []grpc.MethodDesc{
		{
			MethodName: "ProvideAPIKey",
			Handler:    _APIKeyService_ProvideAPIKey_Handler,
		},
	},
	Streams:  []grpc.StreamDesc{},
	Metadata: "cognicore.proto",
